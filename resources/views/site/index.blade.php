                                ...
                                <div class="thumb-content">
                                    ...
                                    <a href="single.html">
                                        <img class="card-img-top img-fluid"
                                            src="{{ asset('siteassets/images/products/products-1.jpg') }}"
                                            alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="product-item bg-light">
                            <div class="card">
                                <div class="thumb-content">
                                    ...
                                    <a href="single.html">
                                        <img class="card-img-top img-fluid"
                                            src="{{ asset('siteassets/images/products/products-2.jpg') }}"
                                            alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="product-item bg-light">
                            <div class="card">
                                <div class="thumb-content">
                                    ...
                                    <a href="single.html">
                                        <img class="card-img-top img-fluid"
                                            src="{{ asset('siteassets/images/products/products-3.jpg') }}"
                                            alt="Card image cap">
                                    </a>
                                </div>
                                <div class="card-body">
